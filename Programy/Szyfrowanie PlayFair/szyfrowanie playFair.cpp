...
string zakoduj(string slowoZakodowane, char tablicaDoSzyfru[6][6]) {
    ...
    for(i = 0; i < rozmiar-1; i += 2) { //PETLA DLA KAZDEJ DWOJKI
        ...
        if(wiersz1 == wiersz2 && kolumna1 == kolumna2) {
            ...
            if(kolumna1 == 5) kolumna1 = 0;
            else ++kolumna1;
            if(kolumna2 == 5) kolumna2 = 0;
            else ++kolumna2;
        } else if(kolumna1 == kolumna2) {
            if(wiersz1 == 5) wiersz1 = 0;
            else ++wiersz1;
            if(wiersz2 == 5) wiersz2 = 0;
            else ++wiersz2;
        } else {
...
int main() {
    ...
    ///////////////////////
    cout << "Wybierz czy podasz sciezke do pliku (wpisz 1) czy podasz slowo do zakodowania w konsoli (wpisz 2): " << endl;
    int wybor;
    cin >> wybor;
    cin.sync();
...
//PROGRAM MA PROBLEM GDY W PLIKU ZNAJDUJE SIE SLOWO Z POLSKIMI ZNAKAMI (znak polski traktuje jako dwie litery)
